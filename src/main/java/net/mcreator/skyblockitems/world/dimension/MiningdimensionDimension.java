...
package net.mcreator.skyblockitems.world.dimension;
...
public class MiningdimensionDimension extends SkyblockitemsModElements.ModElement {
	@ObjectHolder("skyblockitems:miningdimension")
	public static final ModDimension dimension = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public MiningdimensionDimension(SkyblockitemsModElements instance) {
		super(instance, 53);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("miningdimension"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("skyblockitems:miningdimension")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("skyblockitems:miningdimension"), dimension, null, true);
		}
		type = DimensionType.byName(new ResourceLocation("skyblockitems:miningdimension"));
	}
