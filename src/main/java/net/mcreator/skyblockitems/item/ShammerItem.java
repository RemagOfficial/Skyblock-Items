...
public class ShammerItem extends SkyblockitemsModElements.ModElement {
	@ObjectHolder("skyblockitems:shammer")
	public static final Item block = null;
	public ShammerItem(SkyblockitemsModElements instance) {
		super(instance, 1);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("shammer"));
	}
	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(SkyblockitemsItemGroup.tab).maxDamage(1000));
		}
