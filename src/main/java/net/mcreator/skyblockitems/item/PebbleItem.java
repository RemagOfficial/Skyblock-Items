...
public class PebbleItem extends SkyblockitemsModElements.ModElement {
	@ObjectHolder("skyblockitems:pebble")
	public static final Item block = null;
	public PebbleItem(SkyblockitemsModElements instance) {
		super(instance, 15);
	}
