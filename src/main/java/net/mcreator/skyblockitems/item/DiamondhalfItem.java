...
public class DiamondhalfItem extends SkyblockitemsModElements.ModElement {
	@ObjectHolder("skyblockitems:diamondhalf")
	public static final Item block = null;
	public DiamondhalfItem(SkyblockitemsModElements instance) {
		super(instance, 11);
	}
