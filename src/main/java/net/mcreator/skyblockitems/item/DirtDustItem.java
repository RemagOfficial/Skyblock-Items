...
public class DirtDustItem extends SkyblockitemsModElements.ModElement {
	@ObjectHolder("skyblockitems:dirt_dust")
	public static final Item block = null;
	public DirtDustItem(SkyblockitemsModElements instance) {
		super(instance, 40);
	}
