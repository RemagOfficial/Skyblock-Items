...
public class TinymagmaItem extends SkyblockitemsModElements.ModElement {
	@ObjectHolder("skyblockitems:tinymagma")
	public static final Item block = null;
	public TinymagmaItem(SkyblockitemsModElements instance) {
		super(instance, 12);
	}
