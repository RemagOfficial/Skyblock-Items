...
import net.mcreator.skyblockitems.procedures.IronMeshRightClickedOnBlockProcedure;
...
public class IronMeshItem extends SkyblockitemsModElements.ModElement {
	@ObjectHolder("skyblockitems:iron_mesh")
	public static final Item block = null;
	public IronMeshItem(SkyblockitemsModElements instance) {
		super(instance, 50);
	}
	...
	public static class ItemCustom extends Item {
		...
		public ActionResultType onItemUseFirst(ItemStack stack, ItemUseContext context) {
			...
			ItemStack itemstack = context.getItem();
			{
				...
				IronMeshRightClickedOnBlockProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
