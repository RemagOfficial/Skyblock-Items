...
public class BoneMealChunkItem extends SkyblockitemsModElements.ModElement {
	@ObjectHolder("skyblockitems:bone_meal_chunk")
	public static final Item block = null;
	public BoneMealChunkItem(SkyblockitemsModElements instance) {
		super(instance, 34);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("bone_meal_chunk");
		}
