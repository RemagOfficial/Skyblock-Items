...
public class IronhammerItem extends SkyblockitemsModElements.ModElement {
	@ObjectHolder("skyblockitems:ironhammer")
	public static final Item block = null;
	public IronhammerItem(SkyblockitemsModElements instance) {
		super(instance, 3);
	}
	...
	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(SkyblockitemsItemGroup.tab).maxDamage(3000));
		}
