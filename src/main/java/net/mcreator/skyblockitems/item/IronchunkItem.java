...
public class IronchunkItem extends SkyblockitemsModElements.ModElement {
	@ObjectHolder("skyblockitems:ironchunk")
	public static final Item block = null;
	public IronchunkItem(SkyblockitemsModElements instance) {
		super(instance, 14);
	}
