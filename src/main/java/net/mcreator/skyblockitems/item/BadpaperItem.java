...
public class BadpaperItem extends SkyblockitemsModElements.ModElement {
	@ObjectHolder("skyblockitems:badpaper")
	public static final Item block = null;
	public BadpaperItem(SkyblockitemsModElements instance) {
		super(instance, 17);
	}
