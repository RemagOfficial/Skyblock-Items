...
public class NetheritechunkItem extends SkyblockitemsModElements.ModElement {
	@ObjectHolder("skyblockitems:netheritechunk")
	public static final Item block = null;
	public NetheritechunkItem(SkyblockitemsModElements instance) {
		super(instance, 13);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("netheritechunk");
		}
