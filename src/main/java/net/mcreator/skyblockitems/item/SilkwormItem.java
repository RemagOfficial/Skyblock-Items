...
public class SilkwormItem extends SkyblockitemsModElements.ModElement {
	@ObjectHolder("skyblockitems:silkworm")
	public static final Item block = null;
	public SilkwormItem(SkyblockitemsModElements instance) {
		super(instance, 18);
	}
