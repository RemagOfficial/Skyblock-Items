...
public class LifeChunkItem extends SkyblockitemsModElements.ModElement {
	@ObjectHolder("skyblockitems:life_chunk")
	public static final Item block = null;
	public LifeChunkItem(SkyblockitemsModElements instance) {
		super(instance, 42);
	}
