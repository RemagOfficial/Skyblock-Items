...
public class CavebackProcedure extends SkyblockitemsModElements.ModElement {
	public CavebackProcedure(SkyblockitemsModElements instance) {
		super(instance, 128);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure Caveback!");
			return;
		}
