...
public class MiningdimoutProcedure extends SkyblockitemsModElements.ModElement {
	public MiningdimoutProcedure(SkyblockitemsModElements instance) {
		super(instance, 126);
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure Miningdimout!");
			return;
		}
