...
import net.mcreator.skyblockitems.procedures.SeiveOnBlockRightClickedProcedure;
...
public class NetheriteMeshSieveBlock extends SkyblockitemsModElements.ModElement {
	@ObjectHolder("skyblockitems:netherite_mesh_sieve")
	public static final Block block = null;
	public NetheriteMeshSieveBlock(SkyblockitemsModElements instance) {
		super(instance, 47);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("netherite_mesh_sieve");
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				SeiveOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
