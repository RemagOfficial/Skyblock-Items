...
public class SilkMeshSieveBlock extends SkyblockitemsModElements.ModElement {
	@ObjectHolder("skyblockitems:silk_mesh_sieve")
	public static final Block block = null;
	public SilkMeshSieveBlock(SkyblockitemsModElements instance) {
		super(instance, 43);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("silk_mesh_sieve");
		}
