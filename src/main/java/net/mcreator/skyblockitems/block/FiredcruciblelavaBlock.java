...
public class FiredcruciblelavaBlock extends SkyblockitemsModElements.ModElement {
	@ObjectHolder("skyblockitems:firedcruciblelava")
	public static final Block block = null;
	public FiredcruciblelavaBlock(SkyblockitemsModElements instance) {
		super(instance, 30);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("firedcruciblelava");
		}
