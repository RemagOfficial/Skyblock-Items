...
public class DiamondMeshSieveBlock extends SkyblockitemsModElements.ModElement {
	@ObjectHolder("skyblockitems:diamond_mesh_sieve")
	public static final Block block = null;
	public DiamondMeshSieveBlock(SkyblockitemsModElements instance) {
		super(instance, 46);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("diamond_mesh_sieve");
		}
