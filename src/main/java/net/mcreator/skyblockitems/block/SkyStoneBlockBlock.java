...
public class SkyStoneBlockBlock extends SkyblockitemsModElements.ModElement {
	@ObjectHolder("skyblockitems:sky_stone_block")
	public static final Block block = null;
	public SkyStoneBlockBlock(SkyblockitemsModElements instance) {
		super(instance, 38);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sky_stone_block");
		}
