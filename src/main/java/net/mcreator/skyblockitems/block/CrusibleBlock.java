...
public class CrusibleBlock extends SkyblockitemsModElements.ModElement {
	@ObjectHolder("skyblockitems:crusible")
	public static final Block block = null;
	public CrusibleBlock(SkyblockitemsModElements instance) {
		super(instance, 28);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.CLAY).sound(SoundType.GROUND).hardnessAndResistance(0.5f, 10f).lightValue(0).notSolid());
			setRegistryName("crusible");
		}
