...
public class IronMeshSieveBlock extends SkyblockitemsModElements.ModElement {
	@ObjectHolder("skyblockitems:iron_mesh_sieve")
	public static final Block block = null;
	public IronMeshSieveBlock(SkyblockitemsModElements instance) {
		super(instance, 45);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("iron_mesh_sieve");
		}
