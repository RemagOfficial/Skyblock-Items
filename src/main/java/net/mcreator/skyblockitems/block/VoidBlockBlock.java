...
public class VoidBlockBlock extends SkyblockitemsModElements.ModElement {
	@ObjectHolder("skyblockitems:void_block")
	public static final Block block = null;
	public VoidBlockBlock(SkyblockitemsModElements instance) {
		super(instance, 41);
	}
