...
public class FlintMeshSieveBlock extends SkyblockitemsModElements.ModElement {
	@ObjectHolder("skyblockitems:flint_mesh_sieve")
	public static final Block block = null;
	public FlintMeshSieveBlock(SkyblockitemsModElements instance) {
		super(instance, 44);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("flint_mesh_sieve");
		}
