...
public class SeiveBlock extends SkyblockitemsModElements.ModElement {
	@ObjectHolder("skyblockitems:seive")
	public static final Block block = null;
	public SeiveBlock(SkyblockitemsModElements instance) {
		super(instance, 27);
	}
